...
impl StringInterner {
    ...
    pub fn intern(&mut self, string: &str) -> Symbol {
        ...
        let symbol = Symbol { index: self.current_index };
...
impl SessionGlobals {
    ...
    pub fn with_interner<T>(function: impl Fn(&StringInterner) -> T) -> T {
        SESSION_GLOBALS.with(|sg| function(&sg.string_interner.borrow()))
    }

    pub fn with_interner_mut<T>(function: impl Fn(&mut StringInterner) -> T) -> T {
